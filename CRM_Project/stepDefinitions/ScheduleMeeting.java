...
public class ScheduleMeeting {
	...
	public void meetingDetails(String meetingSubject) throws InterruptedException {
		Thread.sleep(3000);
		driver.findElement(By.id("name")).clear();
		driver.findElement(By.id("name")).sendKeys(meetingSubject);
 	}
	
	@And("^Include members to the meeting \"(.*)\", \"(.*)\", \"(.*)\"$")
	...
	public void navigateToViewMeeting() throws InterruptedException {
		Thread.sleep(3500);
